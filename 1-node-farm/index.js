...
// ch20 using Modules 3: 3rd Party Modules
...
//ch20 - using 3rd party module - slugify
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/' || pathname === '/overview') {
    ...
    const cardsHtml = dataObj
      ...
      .join(''); //.join('') joins all the array elements into an empty string, then return a markup with new cards
